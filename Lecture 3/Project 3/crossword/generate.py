...
class CrosswordCreator():
    ...
    def consistent(self, assignment):
        ...
        for key, val in assignment.items():
            ...
            # check for conflict between neighbors
...
def main():
    ...
    structure = "C:\Python3\Introduction to AI with Python\Lecture 3\Project 3\crossword\data\structure0.txt"
    words = "C:\Python3\Introduction to AI with Python\Lecture 3\Project 3\crossword\data\words2.txt"
